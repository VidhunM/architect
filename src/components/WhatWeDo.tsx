...
const services = [
  { icon: '/images/WHAT WE DO/roof.png', title: 'ARCHITECTURE' },
  { icon: '/images/WHAT WE DO/END TO END INTERIOR.png', title: 'END TO END INTERIORS' },
  { icon: '/images/WHAT WE DO/construction.png', title: 'CONSTRUCTION & EXECUTION' },
  { icon: '/images/WHAT WE DO/project-management (1).png', title: 'PROJECT MANAGEMENT' },
  { icon: '/images/WHAT WE DO/CONSULTATION.png', title: 'DESIGN & CONSULTATION' },
  { icon: '/images/WHAT WE DO/home-renovation.png', title: 'RENOVATION & RETROFITTING' },
  { icon: '/images/WHAT WE DO/APPROVALS.png', title: 'REGULATORY APPROVALS' }
];
        ...
        <Slider {...settings}>
          {services.map((service, idx) => (
            <motion.div
              ...
              className="flex items-center justify-center"
            >
              <div className="flex flex-col items-center justify-center text-center w-full px-1 sm:px-2 py-4 gap-2">
                <img
                  src={service.icon}
                  alt={service.title}
