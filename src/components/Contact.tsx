...
//     const fileName = `contact_submission_${ts.getFullYear()}${pad(ts.getMonth() + 1)}${pad(ts.getDate())}_${pad(ts.getHours())}${pad(ts.getMinutes())}${pad(ts.getSeconds())}.csv`;
//     a.href = url;
//     a.download = fileName;
...
//                 We're here to help you create the perfect space. Whether you have a specific 
//                 vision or need guidance on where to start, our team of experts is ready to assist you.
//               </p>
//             </div>
...
//                   <p className="text-sm text-blue-900">We'll respond within 24 hours</p>
//                 </div>
//               </div>
...
//                   <p className="text-blue-900">W-126, 3rd Floor, 3rd Ave, <br />Anna Nagar, Chennai, Tamil Nadu 60004</p>
...
//             <h3 className="text-2xl font-bold text-blue-900 mb-6">Start Your Project</h3>
            
//             {isSubmitted ? (
//               <div className="text-center py-12">
//                 <CheckCircle className="h-16 w-16 text-blue-900 mx-auto mb-4" />
//                 <h4 className="text-xl font-semibold text-blue-900 mb-2">Thank you!</h4>
